...
import listeners.CreateDirectoryDialogOkButtonListener;
...
public class CreateDirectoryDialog extends JDialog {
    ...
    public CreateDirectoryDialog(String implementation) {
    ...
    private void init() {
        ...
        btnOk.addActionListener(new CreateDirectoryDialogOkButtonListener(this, implementation));
